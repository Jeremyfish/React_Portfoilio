...
export default class PortfolioForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      logo: "",
      editMode: false,
      apiUrl: "https://jcrundwell.devcamp.space/portfolio/portfolio_items?order_by=created_at&direction=desc",
      apiAction: "post"
    };
  ...
  componentDidUpdate(){
      ...
      this.setState({
        ...
        url: url || "",
        editMode: true,
        apiUrl: `https://jcrundwell.devcamp.space/portfolio/portfolio_items/${id}`,
        apiAction: "patch",
        ...
        <form onSubmit={this.handleSubmit} className="portfolio-form">
          ...
          <div className="image-uploaders">
            ...
            {this.state.thumb_image_url && this.state.editMode ?
              <div className= "porfolio-manager-image-wrapper">
              <img src={this.state.thumb_image_url}></img>
              <div className="image-removal-link">
                  <a onClick={()=> this.deleteImg("thumb_image")}>
